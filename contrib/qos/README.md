...
This means one can have an always-on BoomCoind instance running, and another local BoomCoind/BoomCoin-qt instance which connects to this node and receives blocks from it.

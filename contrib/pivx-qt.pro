...
RESOURCES += src/qt/BoomCoin.qrc src/qt/BoomCoin_locale.qrc

TRANSLATIONS += src/qt/locale/BoomCoin_bg.ts \
                src/qt/locale/BoomCoin_de.ts \
                src/qt/locale/BoomCoin_en.ts \
                src/qt/locale/BoomCoin_es.ts \
                src/qt/locale/BoomCoin_fi.ts \
                src/qt/locale/BoomCoin_fr.ts \
                src/qt/locale/BoomCoin_it.ts \
                src/qt/locale/BoomCoin_ja.ts \
                src/qt/locale/BoomCoin_pl.ts \
                src/qt/locale/BoomCoin_pt.ts \
                src/qt/locale/BoomCoin_ru.ts \
                src/qt/locale/BoomCoin_sk.ts \
                src/qt/locale/BoomCoin_sv.ts \
                src/qt/locale/BoomCoin_vi.ts \
                src/qt/locale/BoomCoin_zh_CN.ts \
                src/qt/locale/BoomCoin_zh_TW.ts

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IMM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BoomCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BoomCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BoomCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BoomCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BoomCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BoomCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BoomCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BoomCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BoomCoin Core help message to get a list with possible BoomCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BoomCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BoomCoin Core"); // default title

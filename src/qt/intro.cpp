...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BoomCoin Core"),
     ...
     * override -datadir in the BoomCoin.conf file in the default data directory
     * (to be consistent with BoomCoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

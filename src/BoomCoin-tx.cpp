...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BoomCoin Core BoomCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  BoomCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BoomCoin transaction") + "\n" +
                               "  BoomCoin-tx [options] -create [commands]   " + _("Create hex-encoded BoomCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BoomCoin transaction

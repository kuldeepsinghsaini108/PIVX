...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BoomCoin features */
        {"BoomCoin", "masternode", &masternode, true, true, false},
        {"BoomCoin", "masternodelist", &masternodelist, true, true, false},
        {"BoomCoin", "mnbudget", &mnbudget, true, true, false},
        {"BoomCoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"BoomCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BoomCoin", "mnsync", &mnsync, true, true, false},
        {"BoomCoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"BoomCoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use BoomCoind, or the -server option to BoomCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> BoomCoin-cli " + methodname + " " + args + "\n";
}

Contributing to BoomCoin Core
============================

The BoomCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BoomCoin Core project, and is not to be
confused with overall BoomCoin Network Protocol consensus changes.

Whether a pull request is merged into BoomCoin Core rests with the project merge
...
Patches that change BoomCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BoomCoin consensus, it must have been
...
The project leader is the release manager for each BoomCoin Core release.

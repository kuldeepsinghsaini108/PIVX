...
In order to support loading of multiple wallets in BoomCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BoomCoin.cpp.
...
Changes to BoomCoin.cpp
----------------------
BoomCoin.cpp is the entry point into BoomCoin-qt, and as such, will require some minor modifications to provide hooks for
